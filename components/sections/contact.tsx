          ...
          <Card className="hover:shadow-lg hover:scale-[1.02] transition-all duration-300">
            ...
            <CardContent>
              <p className="text-muted-foreground mb-4 hover:text-foreground transition-colors duration-200">
                I'm currently seeking opportunities to grow as a Full-Stack / AI-oriented Software Engineer and open
                to discussing new projects, creative ideas, or collaborations. Whether you're a company looking for an
                engineer or a fellow developer wanting to collaborate, I'd love to hear from you.
              </p>
              <div className="space-y-2">
                ...
                <p className="text-sm">
                  <strong>Availability:</strong> Open to full-time, internship, and entry-level opportunities
                </p>
                <p className="text-sm">
