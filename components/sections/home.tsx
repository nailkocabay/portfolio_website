      ...
      <div className="max-w-4xl mx-auto text-center space-y-8">
        <div className="space-y-4">
          ...
          <h2 className="text-xl md:text-2xl text-muted-foreground hover:text-foreground transition-colors duration-200">
            Computer Engineering Student & Full-Stack / AI-Oriented Software Engineer
          </h2>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto hover:text-foreground transition-colors duration-200">
            Fourth-year Computer Engineering student at Marmara University with interests in Artificial Intelligence and Full-Stack Development. I build end-to-end applications using modern frontend technologies and backend system design principles.
          </p>
        </div>
